CREATE TABLE IF NOT EXISTS space_categories (
	...
	category_id VARCHAR(26) NOT NULL UNIQUE COMMENT '分类业务ID（ULID）',
	name VARCHAR(120) NOT NULL UNIQUE COMMENT '分类名称',
	is_default TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否默认分类',
	created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='空间分类表：管理空间归类维度';
